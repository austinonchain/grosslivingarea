  ...
  return (
    <>
      ...
      <section>
        ...
        <p className="text-muted text-[15px] mt-0 mb-3">The rule is the same everywhere. The housing is not. <Link href={`/${statesIndex.slug}`}>See all 50 states side by side</Link>.</p>
