...
export const ansiPillar = {
  ...
  published: D,
  intro: [
    '**ANSI Z765-2021 is the national standard for measuring the square footage of a house.** It tells you where to put the tape (the outside of the walls), what counts as finished living area, and how to report the number. Since April 2022, Fannie Mae has required appraisers to use it on most single-family appraisals.',
  ...
  body: [
    ...
    },
    {
      ...
      paragraphs: [
        'Square footage under ANSI is measured along the **exterior finished surface** of the outside walls. Wall thickness is inside the number. That is why an ANSI figure is larger than the sum of the rooms you would get from measuring inside each room.',
    ...
    },
    {
      ...
      paragraphs: [
        '**Finished area** is an enclosed space suitable for year-round use, with walls, floor, and ceiling finished to a standard similar to the rest of the house. A garage is never finished area no matter how nice it is. An unheated sunroom is not. A basement rec room with drywall, flooring, and a finished ceiling is finished area (but see the next rule).',
    ...
    },
    {
      ...
      paragraphs: [
        'Finished area is reported in two separate numbers: **above grade** and **below grade**. Only above-grade finished area is gross living area (GLA). Below-grade finished area is reported on its own line and never added to GLA.',
    ...
    },
    {
      ...
      paragraphs: [
        'A finished space only counts if you can reach it from the main body of the house **through other finished space**. A finished attic you can only get to by a pull-down ladder does not count. A finished room over a detached garage, reached by an exterior stair, does not count as part of the house.',
        'This is the rule behind most surprises on appraisals. Details: [the finished-connection rule](/finished-connection-rule).',
      ],
    },
    {
      heading: 'Rule 7: detached structures are reported separately',
      paragraphs: [
        'ANSI measures the house. A detached garage, guest house, pool house, or ADU is measured and reported on its own; its finished area is never folded into the main house GLA. See [do ADUs count toward square footage?](/does-an-adu-count-as-square-footage).',
      ],
    },
    {
  ...
  childrenHeading: 'Every ANSI Z765 rule, one page each',
  faq: [
  ...
  },
  {
    ...
    body: [
      { heading: 'The all-sides rule', paragraphs: [
        'ANSI does not average or apportion. If the front of a level is buried and the back is fully exposed, the entire level is below grade. This is why a **walkout basement** is still a basement and why a **split-level** home can have a "lower level" that is below grade even though it has full-size windows.',
