...
export const ansiQuestions = [
  {
    ...
    body: [
      ...
      { heading: 'FHA ceiling height', paragraphs: [
        'FHA does not use ANSI, and HUD Handbook 4000.1 does not set a numeric minimum ceiling height for living area. FHA appraisers judge whether a space is usable and typical for the market. Many follow the ANSI numbers anyway because they are the only published standard. That is one of several things [ANSI leaves to other rules](/what-ansi-does-not-apply-to).',
      ] },
    ],
    faq: [
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'What is not included', paragraphs: [
        'Exterior measurement does not mean everything inside the footprint counts. Garages, unfinished areas, and open-to-below spaces inside the exterior walls are still deducted. Those deductions follow the other rules in the [ANSI Z765 guide](/ansi-z765-2021).',
      ] },
    ],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'What fixes it', paragraphs: [
        'A permanent, finished stair or hallway from the house to the space. Once the connection is finished, the space is evaluated on its own merits: ceiling height, finish level, and above or below grade. A bonus room over the garage is the classic example.',
      ] },
