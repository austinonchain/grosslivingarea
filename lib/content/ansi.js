...
export const ansiPillar = {
  ...
  intro: [
    ...
    'This guide walks through every rule in the standard in plain English. The standard itself is a short copyrighted document published by Home Innovation Research Labs. We explain it here. We do not reproduce it. Each rule links to a deeper page with the edge cases.',
  ],
  body: [
    {
      heading: 'What ANSI Z765 is and who wrote it',
      paragraphs: [
        'ANSI Z765 is the **American National Standard for Single-Family Residential Buildings: Square Footage, Method for Calculating**. The American National Standards Institute accredits it; Home Innovation Research Labs (the research arm of the National Association of Home Builders) maintains it.',
    ...
    },
    {
      ...
      paragraphs: [
        '**Fannie Mae** requires ANSI Z765-2021 for appraisals on loans with application dates on or after April 1, 2022. The requirement lives in Selling Guide B4-1.3-05 and covers most single-unit appraisal forms, including condos and manufactured homes. Two-to-four-unit properties are outside it.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Finish is judged against the rest of the house. Every finished room needs finished walls, floor, and ceiling and has to be usable all year, whether the house is a basic ranch or a custom build.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'The [stairs page](/do-stairs-count-as-square-footage) works through the tread-and-landing math, and the lofts and open-to-below entries in the [What counts guide](/what-counts-as-square-footage) show how the rule plays out in real floor plans.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'ANSI measures the house. A detached garage, guest house, pool house, or ADU is measured and reported on its own. Its finished area is never included in the main house GLA, which is the answer to most ADU and guest house questions in the [What counts guide](/what-counts-as-square-footage).',
        'Attached space is different. A wing or suite that shares a wall with the house and connects through finished space is measured as part of the house and follows every other rule here.',
      ],
    },
    {
    ...
    {
      heading: 'How to measure a house to ANSI Z765, step by step',
      paragraphs: [
        'The rules work in a fixed order. This is the sequence an appraiser follows on a typical single-family house.',
      ],
      list: [
        'Walk the outside and measure each exterior wall to its finished surface, to the nearest inch or tenth of a foot.',
        'Sketch the footprint of each level and calculate its area from the [exterior dimensions](/exterior-measurement). Upper floors are measured inside, with the wall thickness added back.',
        'Check the ground against every side of each level. A level with any part below grade on any side goes in the [below-grade column](/above-grade-vs-below-grade).',
        'Check ceiling heights. Leave out finished area under 7 feet, allow 6 feet 4 inches under beams and ducts, and run the [sloped ceiling math](/ansi-ceiling-height-requirements) on rooms under the roof.',
        'Take out anything that is not finished area: the garage, unfinished rooms, and openings to the floor below, including the opening above the [stairs](/do-stairs-count-as-square-footage).',
        'Confirm that every finished space is reached through other finished space. Rooms that fail the [finished-connection rule](/finished-connection-rule) come out.',
        'Total the above-grade and below-grade finished area separately, then round each total to the nearest whole square foot under the [precision rule](/ansi-rounding-precision).',
        'Report both numbers and state that the house was measured to ANSI Z765-2021.',
      ],
      ordered: true,
      after: ['Detached structures go through the same steps on their own sketch and their own line. None of their area is added to the main house.'],
    },
    {
      heading: 'How ANSI shows up on an appraisal report',
      paragraphs: [
        'On a Fannie Mae appraisal, the ANSI result lands in the improvements section. Above-grade finished area is the gross living area figure, and the room count next to it covers above-grade rooms only. Below-grade finished and unfinished area go on the basement line.',
        'The appraiser also confirms that the standard was used, or explains why it could not be. That line is the [ANSI compliance statement](/ansi-compliance-statement), and reviewers check it against the sketch and the reported square footage.',
        'Read the sketch. It shows the exterior dimensions of each level and the areas left out, so a buyer, agent, or reviewer can redo the math. When a number on the report looks wrong, the sketch is where to start.',
      ],
    },
    {
      heading: 'ANSI square footage vs. listing and tax record numbers',
      paragraphs: [
        'The ANSI figure is often smaller than the number on a listing, and three habits explain most of the gap. Listings and tax records sometimes fold a finished basement into one total. Some assessors record total building area with the garage included. And some MLS systems use "heated square feet," which picks up heated space that is not finished.',
        'Measuring each room from inside and adding up the rooms misses in the other direction. That sum leaves out walls, closets, and halls, so it comes in under the ANSI number.',
        'When two numbers disagree, ask how each one was produced. The ANSI number is the one measured to a published standard, and it is the one a Fannie Mae appraisal uses. Space-by-space answers for basements, garages, porches, and additions are in [What counts as square footage?](/what-counts-as-square-footage)',
      ],
    },
    {
      heading: 'Common mistakes when applying the standard',
      list: [
        'Calling a walkout or daylight lower level above grade because one side is open. One buried side puts the whole level [below grade](/above-grade-vs-below-grade).',
        'Counting all of a sloped attic room. Only the part with 5 feet of headroom counts, and only when half the room reaches 7 feet.',
        'Counting a finished room reached by a pull-down ladder, an exterior stair, or a door from the garage.',
        'Counting the stairwell on both floors. Stairs count once, on the floor they descend from.',
        'Adding a detached guest house or ADU into the main house total.',
        'Measuring inside the walls and calling the result ANSI square footage.',
      ],
    },
    {
  ...
  faq: [
    ...
    { q: 'Does ANSI Z765 apply to condos?', a: 'Only partly. A condo unit has no exterior wall to measure around, so Fannie Mae has appraisers measure the interior perimeter and apply the rest of the ANSI rules.' },
    { q: 'Is the ANSI Z765 standard free?', a: 'No. Home Innovation Research Labs sells the 2021 edition as a PDF. Fannie Mae publishes free guidance and an FAQ that cover what most homeowners and agents need.' },
  ],
};
...
export const ansiQuestions = [
  {
    ...
    description: 'ANSI ceiling height requirements for square footage: 7 feet for finished area, 6 feet 4 inches under beams and ducts, and the sloped ceiling rule, worked.',
    published: D,
    shortAnswer: 'Under ANSI Z765-2021, finished area must have a ceiling height of at least **7 feet**. Under beams, ducts, and similar obstructions, **6 feet 4 inches** is enough. Under a sloped ceiling, at least **half** of the finished floor area must reach 7 feet, and only the portion with a ceiling of **5 feet or more** is counted. Height is one of the eight measuring rules explained in [ANSI Z765-2021 in plain English](/ansi-z765-2021).',
    body: [
      ...
      { heading: 'How the sloped ceiling rule works', paragraphs: [
        ...
        'Height is only half the test for an attic room. It also has to be reached by a finished stair, not a pull-down ladder, under the [finished-connection rule](/finished-connection-rule). The [official ANSI Z765-2021 PDF](/ansi-z765-pdf) includes diagrams for sloped ceilings.',
      ] },
      { heading: 'Where the height is measured from', paragraphs: [
        'Ceiling height is measured from the **finished floor** to the **finished ceiling**. Unfinished joists in a basement do not get you a finished ceiling, and a dropped ceiling that lands at 6 feet 10 inches takes the room out of finished area. Record heights to the nearest inch, the same [precision ANSI asks for](/ansi-rounding-precision) on every dimension.',
      ] },
      { heading: 'FHA ceiling height', paragraphs: [
        'FHA does not use ANSI, and HUD Handbook 4000.1 does not set a numeric minimum ceiling height for living area. FHA appraisers judge whether a space is usable and typical for the market. Many follow the ANSI numbers anyway because they are the only published standard. That is one of several things [ANSI leaves to other rules](/what-ansi-does-not-apply-to). Ceiling height for a legal bedroom is a building code question too, covered in [ANSI bedroom requirements](/ansi-bedroom-requirements).',
      ] },
    ],
    faq: [
  ...
  },
  {
    ...
    published: D,
    shortAnswer: '**Above grade** means a level of the house that sits entirely above the ground on every side. **Below grade** means any part of the level is below the ground on any side. Under ANSI Z765, only above-grade finished area is gross living area; below-grade finished area is reported separately. The all-sides test is Rule 3 in our [plain-English guide to ANSI Z765-2021](/ansi-z765-2021).',
    body: [
      ...
      { heading: 'Why it matters', paragraphs: [
        'Appraisal forms report **above-grade** rooms and square footage in the GLA line and **below-grade** finished area in the basement line. Comparable sales are matched on GLA, so a 1,500 sq ft above-grade house with a 1,500 sq ft finished basement is compared to other 1,500 sq ft houses, not 3,000 sq ft ones. The basement still adds value, just on its own line.',
        'Grade decides which line the area goes on. How much area there is comes from [exterior measurement](/exterior-measurement) and the [ceiling height rule](/ansi-ceiling-height-requirements).',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'How much wall thickness adds', paragraphs: [
        ...
        'This is one reason the number on an appraisal is larger than the sum of the rooms, and why a home measured with a laser inside each room comes out smaller than the same home measured to ANSI. The area is rounded once, at the end, under the [ANSI precision rule](/ansi-rounding-precision).',
      ] },
      { heading: 'Upper floors and attached homes', paragraphs: [
        ...
        'For townhouses and other attached homes, the standard gives separate guidance for the shared wall, and the appraiser notes which convention was used. Condo units are measured to the interior instead, one of the cases in [what ANSI Z765 does not apply to](/what-ansi-does-not-apply-to).',
      ] },
      { heading: 'What is not included', paragraphs: [
        'Exterior measurement does not mean everything inside the footprint counts. Garages, unfinished areas, and open-to-below spaces inside the exterior walls, including the opening above a [staircase](/do-stairs-count-as-square-footage), are still deducted. Those deductions follow the other rules in the [ANSI Z765 guide](/ansi-z765-2021).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['ansi-rounding-precision'],
  },
  {
    ...
    shortAnswer: '**Yes.** Under ANSI Z765, stair treads and landings are counted as finished area on the floor they **descend from**. The opening in the floor above the staircase is not counted, so the stairs are included exactly once, not on both levels. Stairs and openings are Rule 5 in the [ANSI Z765-2021 guide](/ansi-z765-2021).',
    body: [
      { heading: 'How it works floor by floor', paragraphs: [
        'On a two-story house, the staircase from the second floor to the first is counted with the **second floor**. On the first floor, the space under the stairs is part of the first floor footprint (it is inside the [exterior walls](/exterior-measurement)), so it is counted there too. Nothing is double counted because the second-floor opening above the stairs is excluded.',
        'Stairs down to a basement are counted with the first floor, the level they descend from. If the basement is [below grade](/above-grade-vs-below-grade), the stairs are still above-grade area because they belong to the floor above.',
      ] },
    ...
    sources: [src.hirl, src.fnmaAnsi],
    related: ['finished-connection-rule'],
  },
  {
    ...
    published: D,
    shortAnswer: 'Under ANSI Z765, finished area counts only if it is **connected to the main body of the house through other finished area**. A finished room you can reach only through a garage, an unfinished space, an exterior door, or a pull-down ladder is not part of the house\'s finished square footage. It is Rule 6 in [ANSI Z765-2021](/ansi-z765-2021) and the reason behind many appraisal surprises.',
    body: [
      ...
      { heading: 'What fixes it', paragraphs: [
        'A permanent, finished [stair](/do-stairs-count-as-square-footage) or hallway from the house to the space. Once the connection is finished, the space is evaluated on its own merits: [ceiling height](/ansi-ceiling-height-requirements), finish level, and [above or below grade](/above-grade-vs-below-grade). A bonus room over the garage is the classic example.',
      ] },
  ...
  },
  {
    ...
    published: D,
    shortAnswer: 'ANSI Z765 asks for measurements taken to the **nearest inch or tenth of a foot** and finished area reported to the **nearest whole square foot** (nearest 0.1 square meter in metric). The standard does not require a laser or any specific tool, only that precision. The rules that decide what gets measured are in the [ANSI Z765-2021 guide](/ansi-z765-2021).',
    body: [
      ...
      { heading: 'Rounding in practice', paragraphs: [
        'Round at the end, not wall by wall. Keep the [exterior dimensions](/exterior-measurement) as measured, calculate the area, then round the final finished-area figures for above grade and below grade separately. Those rounded totals are what the appraiser reports along with the [ANSI compliance statement](/ansi-compliance-statement).',
      ] },
    ],
    sources: [src.hirl],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Two-to-four-unit properties', paragraphs: [
        ...
        'For a single-unit home the standard cannot handle, Fannie Mae lets the appraiser report an exception instead, which is part of the [ANSI compliance statement](/ansi-compliance-statement).',
      ] },
      { heading: 'FHA, VA, and USDA', paragraphs: [
        'None of the three require ANSI. FHA appraisers follow HUD Handbook 4000.1, which has its own definitions of living area and does not adopt the ANSI ceiling numbers. An appraiser can measure to ANSI on an FHA assignment as long as the HUD definitions are still honored.',
      ] },
      { heading: 'Things ANSI never addresses', list: [
        'Whether a room is a **legal bedroom** (ANSI has [no bedroom requirements](/ansi-bedroom-requirements) of its own).',
        'Permits and code compliance, which is why an unpermitted addition still gets measured (the lender, not the standard, decides what happens to it).',
  ...
  },
  {
    ...
    published: D,
    shortAnswer: '**No.** ANSI Z765-2021 is the current edition and the one Fannie Mae requires. There is no "ANSI Z765-2022" or "2023"; those are search guesses, not standards. Editions to date: 1996, 2003, 2013, and 2021. We will update this page the day a new edition is published. Every rule in the current edition is explained in [ANSI Z765-2021 in plain English](/ansi-z765-2021).',
    body: [
      { heading: 'What changed in the 2021 edition', paragraphs: [
        'The 2021 revision tightened the definitions of finished area and grade, clarified how [stairs and openings](/do-stairs-count-as-square-footage) are handled, and added guidance for spaces the earlier editions left vague (attached homes, obstructions under ceilings). The core rules, [exterior measurement](/exterior-measurement) and the [7-foot ceiling](/ansi-ceiling-height-requirements), did not change.',
      ...
      { heading: 'How to tell which edition was used', paragraphs: [
        'Appraisal reports written to Fannie Mae\'s requirement state the standard and edition in the [ANSI compliance statement](/ansi-compliance-statement) in the improvements section. If a report just says "ANSI" with no year, or was written before 2022, assume the 2013 edition or none at all. The edition also appears in the title of the [official PDF](/ansi-z765-pdf).',
      ] },
    ],
  ...
  },
  {
    ...
    published: D,
    shortAnswer: 'The official ANSI Z765-2021 PDF is sold by Home Innovation Research Labs, the standard\'s secretariat, for a modest fee. It is a short document, under 20 pages. The standard is copyrighted, so we do not host it and neither should anyone else; free copies floating around are unauthorized and often the [old 2013 edition](/ansi-z765-versions).',
    body: [
      { heading: 'What is inside', list: [
        'Definitions: finished area, grade, above and below grade, living area.',
        'The measuring method: [exterior measurement](/exterior-measurement), [ceiling height rules](/ansi-ceiling-height-requirements), stairs and openings, [the finished-connection rule](/finished-connection-rule).',
        'Reporting: [rounding](/ansi-rounding-precision), how to state above-grade and below-grade area, [the compliance statement](/ansi-compliance-statement).',
        'Diagrams for the tricky cases (sloped ceilings, split levels).',
      ] },
      { heading: 'What is free', paragraphs: [
        'Fannie Mae publishes its Standardized Property Measuring Guidelines and FAQ at no cost. It restates the rules an appraiser needs to comply and answers the questions Fannie has fielded since 2022. For most homeowners and agents it is enough, and this site explains everything in the standard in plain English: [ANSI Z765-2021 explained](/ansi-z765-2021).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'What does decide it', list: [
        '**Egress.** Most codes based on the International Residential Code require a sleeping room to have an emergency escape opening (a window of a minimum size or a door to outside). Whether that window changes the square footage is a separate question, and the answer is no: the grade test in the [ANSI Z765 guide](/ansi-z765-2021) is about ground, not windows.',
      ...
      { heading: 'Fannie Mae and FHA bedroom requirements', paragraphs: [
        'Fannie Mae has no bedroom size or count requirement; it asks the appraiser to describe the property accurately. FHA likewise has no numeric bedroom rule, though HUD 4000.1 requires bedrooms to have egress for safety. Bedrooms are only one of the things [the standard stays silent on](/what-ansi-does-not-apply-to).',
      ] },
    ],
