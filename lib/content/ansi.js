  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'What is not included', paragraphs: [
        'Exterior measurement does not mean everything inside the footprint counts. Garages, unfinished areas, and open-to-below spaces inside the exterior walls are still deducted. The [What counts guide](/what-counts-as-square-footage) covers those deductions space by space.',
      ] },
    ],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'What fixes it', paragraphs: [
        'A permanent, finished stair or hallway from the house to the space. Once the connection is finished, the space is evaluated on its own merits: ceiling height, finish level, and above or below grade. The bonus-room-over-garage entry in the [What counts guide](/what-counts-as-square-footage) is the classic example.',
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Things ANSI never addresses', list: [
        ...
        'Permits and code compliance, which is why an unpermitted addition still gets measured (the [What counts guide](/what-counts-as-square-footage) explains what happens to it on the lending side).',
