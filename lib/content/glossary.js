...
// Zoning and floor area ratio were left out: the site covers ANSI Z765 only, not zoning.
// No links on term pages (no external links anywhere on the site); `wikipedia` feeds DefinedTerm sameAs only.
