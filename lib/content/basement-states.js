...
// URL: /<state-name>/<feature>, e.g. /ohio/finished-basement (served by app/[...slug]).
...
for (const f of FEATURES) {
  for (const st of STATES) {
    basementStateQuestions.push({
      ...
      verdictLine: `No, ${f.a} does not count as square footage in ${st.name}.`,
