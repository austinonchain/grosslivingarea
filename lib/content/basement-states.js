...
for (const f of FEATURES) {
  for (const st of STATES) {
    basementStateQuestions.push({
      ...
      shortAnswer: f.verdict(st.name, st.slug),
      body: [
