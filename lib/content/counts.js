...
import basementData from '../data/basement.js';
const D = '2026-08-27';
const D2 = '2026-09-11';
...
export const countsPillar = {
  ...
  intro: [
    ...
    'Every row in the table below links to a page with the verdict, the ANSI rule behind it, and the Fannie Mae or FHA wrinkle. After the table, the same spaces are grouped by where they sit in the house. The rules themselves are explained in [ANSI Z765-2021, every rule in plain English](/ansi-z765-2021).',
  ],
  body: [
    {
      ...
      table: {
        ...
        rows: [
          ['[Basement, any kind](/does-a-basement-count-as-square-footage)', 'No (below grade; answer by state on the page)', 'All-sides grade rule'],
          ...
          ['[Unfinished basement](/does-an-unfinished-basement-count-as-square-footage)', 'No (not living area at all)', 'All-sides grade rule'],
          ['[Partially finished basement](/does-a-partially-finished-basement-count-as-square-footage)', 'No (finished part reported below grade)', 'All-sides grade rule'],
    ...
    {
      heading: 'Basements and lower levels',
      paragraphs: [
        'No basement counts as gross living area, whatever kind it is. ANSI Z765 puts any level with part of its floor below the ground on any side in the below-grade column, so [a basement of any kind](/does-a-basement-count-as-square-footage) is measured and reported on its own line. The finish decides which line.',
        'A [finished basement](/does-a-finished-basement-count-as-square-footage) with finished walls, floor, and ceiling, plus heat, is reported as below-grade finished area. An [unfinished basement](/does-an-unfinished-basement-count-as-square-footage) with bare concrete and open joists is reported as unfinished. A [partially finished basement](/does-a-partially-finished-basement-count-as-square-footage) is split room by room, and a room missing any one of the finished surfaces stays on the unfinished side.',
        'Light and access do not change the grade. A [walkout basement](/does-a-walkout-basement-count-as-square-footage) with a door at the back is still buried at the front, and a [daylight or lookout basement](/does-a-daylight-basement-count-as-square-footage) gets the same answer with bigger windows. [Egress windows](/do-egress-windows-count-as-square-footage) make a room a legal bedroom, but a [basement bedroom](/does-a-basement-bedroom-count-as-square-footage) is still below-grade area.',
        'The same test catches houses that do not look like they have a basement. The lower floor of a [split-level home](/does-a-split-level-lower-floor-count-as-square-footage), the bottom half of a [raised ranch](/does-a-raised-ranch-lower-level-count-as-square-footage), and the lower level of a [hillside home](/does-a-hillside-home-lower-level-count-as-square-footage) usually sit a few feet into the ground on at least one side. When they do, they are below grade. When the ground is below the floor on every side, they count.',
        'Finishing a basement adds value but never moves it into gross living area. What does raise the appraisal is covered in [how to make a basement count](/how-to-make-a-basement-count-as-square-footage).',
      ],
    },
    {
      heading: 'Attics, lofts, and upper floors',
      paragraphs: [
        'Upstairs space usually fails on one of two rules: ceiling height or access. A [finished attic](/does-a-finished-attic-count-as-square-footage) counts when at least half its floor has a 7-foot ceiling and it is reached by a finished stairway. Only the part with 5 feet or more of headroom goes into the number, and a pull-down ladder disqualifies the whole room.',
        'The upstairs of a [Cape Cod](/does-a-cape-cod-second-floor-count-as-square-footage) runs into the same sloped ceiling math, which is why it measures smaller than the floor below. Dormers win some of that area back.',
        'A [bonus room over a garage](/does-a-bonus-room-over-a-garage-count-as-square-footage) counts when you reach it from inside the house. If the only stair rises from the garage floor, it does not. A [loft](/does-a-loft-count-as-square-footage) counts for its own floor, measured to the railing, while the open space it looks down on is counted once, on the floor below.',
      ],
    },
    {
      heading: 'Garages, additions, and separate units',
      paragraphs: [
        'A [garage](/does-a-garage-count-as-square-footage) never counts, attached or detached, heated or not. Its area goes on its own line as garage space. The one way out is a complete [garage conversion](/does-a-garage-conversion-count-as-square-footage): the garage door gone, a finished floor at house level, heat, a 7-foot ceiling, and a finished connection to the house.',
        'Separate buildings stay separate. A [guest house or garage apartment](/does-a-garage-apartment-count-as-square-footage) is measured on its own, and so is a [shed, pool house, or other outbuilding](/does-a-shed-count-as-square-footage), however well it is finished. A detached [ADU](/does-an-adu-count-as-square-footage) is reported with its own square footage and room count.',
        'For attached space, the connection decides. An [in-law suite](/does-an-in-law-suite-count-as-square-footage) that is above grade, finished, and has a door into the house through finished space counts as part of the house. The same suite with only an outside entrance is reported separately.',
        'Permits are a separate question. ANSI has no permit rule, so an [unpermitted addition](/does-an-unpermitted-addition-count-as-square-footage) is measured like any other finished space. The lender decides what it is worth and whether it has to be permitted first.',
      ],
    },
    {
      heading: 'Sunrooms, porches, and breezeways',
      paragraphs: [
        'A room with glass on three sides counts only when it is built like the rest of the house. A four-season [sunroom](/does-a-sunroom-count-as-square-footage) with insulated walls, permanent heating and cooling, a finished floor, and a permanent foundation counts. A three-season room does not, even with a space heater.',
        'A [screened porch](/does-a-screened-porch-count-as-square-footage) is not enclosed living space, and neither is a deck, balcony, covered patio, or open porch. Each one is measured and valued separately.',
        'A [breezeway](/does-a-breezeway-count-as-square-footage) counts only when it is enclosed and finished. It matters beyond its own few square feet: an enclosed, finished breezeway can join a room on the far side to the house, while an open one leaves that room a separate structure.',
      ],
    },
    {
      heading: 'Inside the house: closets, bump-outs, and utility space',
      paragraphs: [
        'On a finished, above-grade floor, nearly everything inside the exterior walls counts. [Closets, hallways, and bathrooms](/do-closets-count-as-square-footage) are all in the number, because ANSI measures the whole floor instead of adding up rooms. A [laundry or mechanical room](/does-a-laundry-room-count-as-square-footage) counts too when it is finished like the rest of the house. A furnace room with a concrete floor and open framing does not.',
        'Small shapes in the footprint follow the exterior measurement. A [bay window](/does-a-bay-window-count-as-square-footage) with a floor at room level counts, and a box bay above the floor does not. A [cantilevered floor](/does-a-cantilever-count-as-square-footage) counts out to its outside wall even with open air beneath it. A [chimney](/does-a-chimney-count-as-square-footage) inside the wall line is part of the footprint; one bumped out from the wall is not.',
        'Heat is the test people reach for most often, and it is the wrong one. [Heated space](/does-heated-space-count-as-square-footage) is not automatically living area. A heated garage, a heated three-season room, and a heated basement each fail a different rule and stay out.',
      ],
    },
    {
      heading: 'How to check the square footage on a listing',
      paragraphs: ['A listing number is a starting point. These steps get you close to the gross living area an appraiser will report.'],
      list: [
        'Find out where the number came from: the tax record, the builder, the MLS, or a past appraisal.',
        'Subtract any basement area. Every basement is below grade, finished or not.',
        'Subtract the garage, porches, decks, and any three-season room.',
        'Take out detached buildings, including a guest house or detached ADU.',
        'Look at rooms under the roof. Only area with 5 feet of headroom counts, and only when half the room reaches 7 feet.',
        'Check how upstairs rooms are reached. A room you can only get to by a ladder or through the garage comes out.',
      ],
      ordered: true,
      after: ['What is left will not match the appraisal to the foot. It will tell you whether the listing number is in the right range.'],
    },
    {
  ...
  faq: [
    ...
    { q: 'Does an attic count as square footage?', a: 'A finished attic counts when at least half its floor has a 7-foot ceiling and a finished stair leads to it. Only the part with 5 feet or more of headroom is included. An unfinished attic never counts.' },
    { q: 'Does a sunroom count as square footage?', a: 'Only a four-season room built and heated like the rest of the house. A three-season room is reported like a porch.' },
    { q: 'Does a detached ADU or guest house count?', a: 'No. Detached buildings are measured and reported on their own line and never added to the main house.' },
    { q: 'Is gross living area the same as total finished area?', a: 'No. Gross living area is finished above-grade area only. A total finished figure on a listing often adds a finished basement, which appraisers report separately.' },
  ],
};

const P = 'what-counts-as-square-footage';
const basementSrc = [src.fnma, src.fnmaAnsi, src.hirl];
// Shared data sections for the basement family (national numbers; state pages carry the state versions).
const usNow = basementData.us['2024'];
const usCensus = basementData.census.US;
const basementNumbers = {
  heading: 'How many homes have a basement',
  paragraphs: [
    `Across the country, ${Math.round(usNow.pct_basement)}% of single-family homes sit over a basement, and ${Math.round(usNow.pct_basement_finished_of_basements)}% of those basements are finished, according to the 2024 Residential Energy Consumption Survey. The share swings from over 80% in Pennsylvania and New York to under 3% in Florida and Texas.`,
    `The number that explains most square footage arguments: ${Math.round(usNow.pct_owners_count_basement_in_sqft)}% of owners with a basement include it when they report their home's size. Under ANSI Z765 none of them should. The same figures for every state are on the state pages, linked from the home page.`,
  ],
};
const basementCalculator = (label, separateLabel) => ({
  heading: `Calculator: what ${label} adds`,
  paragraphs: ['Enter the basement area and the above-grade area. The first figure is the gross living area an appraiser reports. The last is the inflated number a listing shows when it adds the basement in.'],
  calculator: { featureLabel: label.replace(/^an? /, ''), counts: false, separateLabel },
});
const basementTrend = {
  heading: `Fewer new homes get a basement every decade`,
  paragraphs: [
    `In ${usCensus[0][0]}, ${usCensus[0][1]}% of new single-family houses in the United States were built with a full or partial basement. In ${usCensus[usCensus.length - 1][0]} it was ${usCensus[usCensus.length - 1][1]}%. Slab and crawl-space construction took over as building shifted south and west, which is why the basement question is a Northeast and Midwest question more than a national one.`,
  ],
  chart: {
    series: [
      { label: 'Midwest', points: basementData.census.Midwest, color: '#1f5fbf' },
      { label: 'United States', points: usCensus, color: '#9ca3af' },
    ],
    caption: `Share of new single-family houses completed with a full or partial basement. Source: U.S. Census Bureau, Survey of Construction.`,
  },
};
...
export const countsQuestions = [
  {
    slug: 'does-a-basement-count-as-square-footage',
    pillar: P,
    question: 'Does a basement count as square footage?',
    metaTitle: 'Does a Basement Count as Square Footage? | The ANSI Answer',
    description: 'Does a basement count as square footage? Not as gross living area under ANSI Z765, finished or not. The rule, the numbers for every state, and a calculator.',
    published: D2, verdict: BELOW,
    shortAnswer: '**No, not as gross living area.** Under ANSI Z765 any level with part of its floor below ground on any side is below grade, and a basement is below grade by definition. A finished basement is measured and reported as **below-grade finished area** on its own line. An unfinished one is measured but is not living area at all. The finish, the windows, and the state do not change that.',
    body: [
      { heading: 'The rule that keeps every basement out of GLA', paragraphs: [
        'Gross living area is finished, above-grade space. ANSI Z765 decides "above grade" with one test: is any part of the level below the ground on any side? If so, the whole level is below grade. That single test covers the standard basement, the [walkout basement](/does-a-walkout-basement-count-as-square-footage) with a door at the back, and the [daylight basement](/does-a-daylight-basement-count-as-square-footage) with full windows. Fannie Mae requires appraisers to follow the standard, so the answer is the same in every state.',
        'The appraiser still measures the basement. It is reported on the basement line of the report as total area and finished area, and it is valued with its own adjustment. Every other space in the house is ruled on in the [what counts guide](/what-counts-as-square-footage).',
      ] },
      { heading: 'Finished, unfinished, or somewhere in between', list: [
        '**Finished:** finished walls, floor, and ceiling, heated, usable year-round. Reported as below-grade finished area. See [does a finished basement count](/does-a-finished-basement-count-as-square-footage).',
        '**Unfinished:** bare concrete and open joists. Measured, noted as unfinished, not living area. See [does an unfinished basement count](/does-an-unfinished-basement-count-as-square-footage).',
        '**Partially finished:** only the finished rooms go on the finished line. See [does a partially finished basement count](/does-a-partially-finished-basement-count-as-square-footage).',
      ] },
      basementNumbers,
      basementCalculator('a basement', 'below-grade area'),
      basementTrend,
    ],
    faq: [
      { q: 'Does square footage include the basement?', a: 'Not the square footage an appraiser reports as gross living area. Listings and tax records often add a finished basement into a total, which is why two sources can show different numbers for the same house.' },
      { q: 'When can you count basement square footage?', a: 'Only when the level has no part below ground on any side. At that point it is not a basement under ANSI Z765; it is a ground floor. Any level that is below ground anywhere is below-grade area.' },
      { q: 'Does a basement count as livable square footage?', a: 'A finished basement is livable in the everyday sense and is reported as finished below-grade area. It is not included in gross living area, which is the figure appraisers and lenders compare houses on.' },
    ],
    sources: basementSrc,
    related: ['does-a-finished-basement-count-as-square-footage', 'does-an-unfinished-basement-count-as-square-footage', 'does-a-walkout-basement-count-as-square-footage'],
  },
  {
    slug: 'does-an-unfinished-basement-count-as-square-footage',
    pillar: P,
    question: 'Does an unfinished basement count as square footage?',
    metaTitle: 'Does an Unfinished Basement Count as Square Footage? | The Rule',
    description: 'Does an unfinished basement count as square footage? No. It is below grade and not living area. What the appraiser does with it and what finishing changes.',
    published: D2, verdict: NO,
    shortAnswer: '**No.** An unfinished basement is not living area of any kind. ANSI Z765 keeps every basement out of gross living area because it is below grade, and an unfinished one does not make the below-grade finished line either. The appraiser measures it and reports it as unfinished below-grade area, which carries a small adjustment for the space and the storage. The other basement answers are grouped in our guide to [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'What "unfinished" means to an appraiser', paragraphs: [
        'Bare or painted concrete floors, exposed joists overhead, unfinished block or poured walls, and the furnace and water heater in plain view. A workshop bench and a second refrigerator do not change the classification. Neither does heat, since the furnace usually sits down there anyway. If part of the basement has finished walls, floor, and ceiling, that part is finished and the rest is not, which is covered in [does a partially finished basement count](/does-a-partially-finished-basement-count-as-square-footage).',
      ] },
      { heading: 'Where it shows up on the appraisal', paragraphs: [
        'The basement line of the report carries two numbers: total basement area and finished basement area. An unfinished basement fills in the first and leaves the second at zero. The value adjustment for unfinished space is real but small, because buyers are paying for storage and the option to finish it, not for living space.',
      ] },
      { heading: 'Does finishing it change the answer?', paragraphs: [
        'Finishing moves the area from the unfinished line to the finished line. It never moves it into gross living area, because the level is still below grade. The full explanation is in [does a basement count as square footage](/does-a-basement-count-as-square-footage), and what finishing is actually worth is in [how to make a basement count](/how-to-make-a-basement-count-as-square-footage).',
      ] },
      basementCalculator('an unfinished basement', 'unfinished below-grade area'),
    ],
    faq: [
      { q: 'Is an unfinished basement included in the square footage of a house on a listing?', a: 'It should not be, and most MLS systems keep it in a separate basement field. Some listings and tax records add it into a total anyway, which is why the appraisal comes in with a smaller number.' },
      { q: 'Does an unfinished basement add value?', a: 'Some. Appraisers make a small adjustment for unfinished below-grade area, well below the rate for finished space, because buyers value the storage and the option to finish it.' },
    ],
    sources: basementSrc,
    related: ['does-a-basement-count-as-square-footage', 'does-a-partially-finished-basement-count-as-square-footage', 'does-a-finished-basement-count-as-square-footage'],
  },
  {
    slug: 'does-a-partially-finished-basement-count-as-square-footage',
    pillar: P,
    question: 'Does a partially finished basement count as square footage?',
    metaTitle: 'Does a Partially Finished Basement Count as Square Footage? | How It Is Split',
    description: 'Does a partially finished basement count as square footage? Not as GLA. Only the finished rooms go on the below-grade finished line. How appraisers split it.',
    published: D2, verdict: BELOW,
    shortAnswer: '**No, and only the finished part counts even as below-grade finished area.** ANSI Z765 keeps the whole basement out of gross living area because it is below grade. Within the basement the appraiser measures the finished rooms separately: space with finished walls, floor, and ceiling goes on the finished line, and everything else is reported as unfinished. The same grade rule runs through every basement entry in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'How the appraiser splits it', paragraphs: [
        'The appraiser walks the basement and measures the rooms that are finished on all three surfaces and heated like the rest of the house: a family room, a bedroom with an egress window, a finished bath. Those go on the finished line. The mechanical room, the storage area with open joists, and the laundry corner on bare concrete go on the unfinished side. The total of the two is the basement area, and none of it joins the GLA, as explained in [does a basement count as square footage](/does-a-basement-count-as-square-footage).',
      ] },
      { heading: 'What does not make a room finished', list: [
        'A painted or epoxy concrete floor with no finished walls.',
        'A drop ceiling over an otherwise bare room.',
        'Drywall on the walls with open joists overhead.',
        'Carpet laid on concrete between block walls.',
      ], after: ['Each of these is an improvement, and an appraiser may note it, but the room stays on the unfinished line until all three surfaces are done. Once it is, it is treated like any [finished basement](/does-a-finished-basement-count-as-square-footage) area.'] },
      basementCalculator('a partially finished basement', 'below-grade finished area'),
    ],
    faq: [
      { q: 'Does a half-finished basement count as living space?', a: 'The finished half is reported as below-grade finished area, which appraisers value separately. The unfinished half is not living space. Neither half is gross living area.' },
      { q: 'What makes a basement room finished?', a: 'Finished walls, a finished floor, and a finished ceiling, with heat, so the room is usable year-round like the rest of the house. Miss one surface and the room is unfinished for appraisal purposes.' },
    ],
    sources: basementSrc,
    related: ['does-a-basement-count-as-square-footage', 'does-an-unfinished-basement-count-as-square-footage', 'does-a-finished-basement-count-as-square-footage'],
  },
  {
    ...
    description: 'Does a finished basement count as square footage? Not as gross living area under ANSI Z765. Why it sits on its own line, the numbers by state, and a calculator.',
    ...
    body: [
      ...
      { heading: 'Unfinished basements', paragraphs: [
        '[Unfinished basement](/does-an-unfinished-basement-count-as-square-footage) area is reported as below-grade **unfinished** area. It is not living area of any kind, above or below grade.',
      ] },
      basementNumbers,
      basementCalculator('a finished basement', 'below-grade finished area'),
      basementTrend,
    ],
    faq: [
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'The one real exception', paragraphs: [
        'If a lower level sits entirely above ground on every side (some [hillside](/does-a-hillside-home-lower-level-count-as-square-footage), [split-level](/does-a-split-level-lower-floor-count-as-square-footage), and [raised ranch](/does-a-raised-ranch-lower-level-count-as-square-footage) homes), it is not below grade at all under ANSI\'s all-sides rule and counts as GLA. That is a fact about the site, not something a remodel can create.',
      ] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    published: D, verdict: BELOW,
    shortAnswer: '**No.** A daylight (or lookout) basement has windows that sit above ground because the foundation is raised or the lot slopes, but the floor and part of the walls are still below grade. Under ANSI Z765 it is **below-grade finished area**, like [any other basement](/does-a-basement-count-as-square-footage). It is valued a step above a windowless basement, not as living area. Every basement type gets the same treatment in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      ...
      ], after: ['All three fail ANSI\'s all-sides rule the same way. The names describe light and access, not grade. Adding [egress windows](/do-egress-windows-count-as-square-footage) does not change the answer either.'] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    published: D, verdict: BELOW,
    shortAnswer: '**Not as gross living area.** A basement bedroom, even a fully legal one with an egress window and closet, is below grade under ANSI Z765 and is reported as **below-grade finished area**. Its bedroom status matters for the room count and for value, but it never moves the square footage above grade. Bedrooms are one of the basement questions covered in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Two separate questions', paragraphs: [
        '"Is it a legal bedroom?" is a **building code** question: [egress](/do-egress-windows-count-as-square-footage), minimum size, ceiling height, heat. "Does it count as GLA?" is an **ANSI grade** question. A room can pass the first and fail the second, which is exactly what a good basement bedroom does. ANSI Z765 has no bedroom rules of its own; it only measures.',
      ] },
      { heading: 'How it shows up on the appraisal', paragraphs: [
        'Fannie Mae forms report above-grade bedrooms in the room count and below-grade bedrooms in the basement description ("2 bedrooms, 1 bath below grade"). A listing that says "4 bedrooms" for a house with two upstairs and two in the basement will be written up as a 2-bedroom with a [finished basement](/does-a-finished-basement-count-as-square-footage) containing two bedrooms.',
      ] },
    ],
  ...
  },
  {
    ...
    body: [
      { heading: 'Why split-levels cause arguments', paragraphs: [
        ...
        'Fannie Mae allows the appraiser to explain that the market treats the lower level as living area and to adjust value accordingly, while still reporting the square footage below grade. A [hillside home lower level](/does-a-hillside-home-lower-level-count-as-square-footage) gets the same treatment.',
      ] },
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Usually not as gross living area.** A raised ranch (bi-level) has a lower level set partway into the ground, so under ANSI Z765 it is **below-grade** finished area even when it holds bedrooms, a family room, and full-size windows. Only if the lower level sits fully above ground on every side does it count as GLA. Every lower level on the site is judged by that one test, listed in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'How appraisers report a raised ranch', paragraphs: [
        'Typically as a one-story house with a [finished basement](/does-a-finished-basement-count-as-square-footage): the upper floor is the GLA, and the lower level is finished below-grade area with its own room count. Buyers used to seeing "2,200 sq ft" on the listing are surprised by an appraisal showing 1,100 above grade plus 1,100 below. The value can still come out the same; the split is a reporting rule from ANSI\'s grade test, not a discount. The lower floor of a [split-level home](/does-a-split-level-lower-floor-count-as-square-footage) is judged the same way.',
      ] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    shortAnswer: '**No.** An egress window makes a basement room a **legal bedroom** under the building code; it does not make the basement **above grade** under ANSI Z765. The grade test is about where the ground sits against the walls, and a window well is an exception to the grade, not a change to it. The room stays below-grade finished area. For the rest of the basement answers, see [what counts as square footage](/what-counts-as-square-footage).',
    body: [
  ...
  },
  {
    ...
    body: [
      { heading: 'The ceiling math, worked', paragraphs: [
        'A finished attic room is 24 by 14 feet (336 sq ft). The ridge runs down the middle. Headroom is 7 feet or more across the center 8 feet of width (192 sq ft, 57%), so the room qualifies. Headroom is 5 feet or more across the center 11 feet (264 sq ft). **264 sq ft counts**; the 72 sq ft under the eaves does not. A [Cape Cod second floor](/does-a-cape-cod-second-floor-count-as-square-footage) runs the same numbers, as do the other attic-style spaces in the [What counts guide](/what-counts-as-square-footage).',
      ] },
      { heading: 'Access', paragraphs: [
        'A pull-down stairway or scuttle hole fails ANSI\'s finished-connection rule no matter how well the attic is finished. A permanent stair with finished walls fixes it. A [bonus room over a garage](/does-a-bonus-room-over-a-garage-count-as-square-footage) whose only stair is in the garage fails the same rule, and so does a [loft](/does-a-loft-count-as-square-footage) reached by a ladder. This is the exact scenario on many real estate license exams.',
      ] },
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Yes, if you reach it through the house.** A finished bonus room over an attached garage counts as gross living area under ANSI Z765 when it is finished like the rest of the house, meets the **7-foot ceiling** rule (with the sloped-ceiling allowance), and is entered from **finished space inside the house**. If the only way up is a stair inside the garage or from outside, it fails the finished-connection rule and does not count. Rooms over garages sit with attics and lofts in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Common ways bonus rooms fail', list: [
        'Stair rises from the garage floor (unfinished space).',
        'Knee-wall ceilings that put less than half the room at 7 feet, which fails the ANSI ceiling rule, the same problem a [Cape Cod second floor](/does-a-cape-cod-second-floor-count-as-square-footage) runs into.',
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Dormers', paragraphs: [
        ...
        'Knee walls cut into a [bonus room over a garage](/does-a-bonus-room-over-a-garage-count-as-square-footage) the same way, and a [finished attic](/does-a-finished-attic-count-as-square-footage) with no dormers is the same math with less headroom.',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**The loft floor counts; the opening it overlooks does not.** Under ANSI Z765 a finished loft with a **7-foot ceiling** reached by a permanent stair is gross living area, measured to its railing or edge. The **open-to-below** area (the two-story space it looks down into) is counted once, on the floor below, and never on the loft level. Lofts are grouped with attics and upper floors in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'What disqualifies a loft', list: [
        'Ceiling under 7 feet over more than half the floor, which fails the ANSI ceiling rule (the same test a [finished attic](/does-a-finished-attic-count-as-square-footage) has to pass).',
      ...
      { heading: 'Two-story foyers and great rooms', paragraphs: [
        'The volume over a two-story living room is not floor. It is counted on the first floor only. A second-floor [hallway](/do-closets-count-as-square-footage) that bridges across it is counted for its own width. Same principle as stairs: count floor, not air.',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['does-a-finished-attic-count-as-square-footage'],
  },
  {
    ...
    published: D, verdict: NO,
    shortAnswer: '**No, never.** A garage is not finished living area under ANSI Z765, so it is never part of gross living area, whether it is attached, heated, insulated, drywalled, or has an epoxy floor. Its area is reported separately on the appraisal as garage space. Only a **completed conversion** into a finished room, connected to the house, changes that. Conversions, ADUs, and outbuildings are covered in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Does Zillow square footage include the garage?', paragraphs: [
      ...
      { heading: 'Heated garages and workshops', paragraphs: [
        'Heat does not make space living area. Adding a heater does not change that; [heat alone is not enough](/does-heated-space-count-as-square-footage). A garage used as a workshop is still a garage. A detached workshop is an outbuilding, covered with [sheds and pool houses](/does-a-shed-count-as-square-footage).',
      ] },
    ...
    faq: [
      ...
      { q: 'Does the sq ft on Zillow include the garage?', a: 'Not intentionally. If a Zillow number runs a few hundred square feet larger than the appraisal, a garage lumped into the tax record is the usual reason.' },
    ],
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Yes, when the conversion is complete.** A former garage counts as gross living area under ANSI Z765 once it is a **finished room**: finished floor at house level, finished walls and ceiling, heat, a 7-foot ceiling, and a **finished connection** to the rest of the house. A garage with drywall and a rug but a garage door and a slab step-down is [still a garage](/does-a-garage-count-as-square-footage). Every garage and add-on space is ruled on in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Does a porch add square footage on the listing?', paragraphs: [
        'Listing agents sometimes count enclosed porches. Buyers should treat any such number as marketing until the appraiser measures it. An enclosed walkway to the garage is a separate case, covered under [breezeways](/does-a-breezeway-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnma],
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Only if it is enclosed and finished.** A breezeway that is walled in, heated, and finished to the house standard counts as gross living area under ANSI Z765 like any hallway. An **open or screened** breezeway does not count, and, importantly, it does **not** create a finished connection: a finished room on the far side of an open breezeway is still a separate structure. Connectors are one of the finished-area questions in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Why the breezeway decides more than its own area', paragraphs: [
        'ANSI\'s finished-connection rule needs finished space all the way from the house to the room. An enclosed breezeway can turn a garage apartment or guest suite into part of the house; an open one leaves it [reported separately](/does-a-garage-apartment-count-as-square-footage). On its own, an open breezeway is treated like a [screened porch](/does-a-screened-porch-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**For measuring, yes. For value and lending, it is a problem.** ANSI Z765 has no permit rule: a finished, above-grade, connected addition is measured and included in gross living area. But Fannie Mae and FHA require the appraiser to **report** unpermitted work, and the lender may require permits, give the area reduced or zero value, or decline the loan. How permits fit with the other space rules is covered in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Will an appraiser report unpermitted work?', paragraphs: [
        'Yes, if it is apparent. Appraisers compare the house to public records and the sketch; an extra 300 sq ft that the assessor does not know about gets a comment. The same goes for an unpermitted [garage conversion](/does-a-garage-conversion-count-as-square-footage) or [in-law suite](/does-an-in-law-suite-count-as-square-footage). They are not code inspectors, but they are required to describe the property accurately and to note anything that affects marketability or safety.',
      ] },
  ...
  },
  {
    ...
    published: D, verdict: NO,
    shortAnswer: '**No.** Sheds, pool houses, workshops, barns, and any other **detached** building are separate structures under ANSI Z765 and are never added to the house\'s gross living area, even when fully finished, heated, and plumbed. They are described and valued on their own as site improvements or accessory buildings. Every detached structure gets the same answer in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Yes, if it has a floor.** Because ANSI Z765 measures to the exterior walls, a bay window that extends the room\'s **floor** to the outside wall of the bay, with a ceiling of at least **7 feet**, is included in gross living area. A **box bay** or window seat that projects from the wall above floor level, with no floor beneath it at room level, is not. Bump-outs like this are grouped in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'How appraisers handle it', paragraphs: [
        'The bay is measured as a small bump in the exterior footprint. On a sketch it adds a few square feet, which is why bay windows show up as odd angles on appraisal drawings. That is a direct result of ANSI measuring from the outside of the walls. A [cantilevered floor](/does-a-cantilever-count-as-square-footage) and an interior [chimney](/does-a-chimney-count-as-square-footage) follow the same exterior logic.',
      ] },
  ...
  },
  {
    ...
    shortAnswer: '**Yes.** ANSI Z765 measures each floor to its own exterior walls, so a second floor that overhangs the first by two feet is measured to the overhang and the whole floor counts as gross living area. The fact that there is open air or a porch roof beneath it does not matter. A roof overhang or eave with no floor above it does not count. The other footprint questions are in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Measuring an overhang', paragraphs: [
        'Because you cannot walk around a cantilevered second floor, the appraiser measures it from inside and adds the wall thickness, or measures the overhang from below. Garrison-style colonials and modern boxes with cantilevered upper floors are the usual cases. They count because ANSI measures the exterior, and a cantilever has an exterior. A [bay window](/does-a-bay-window-count-as-square-footage) with a floor is the same idea on a smaller scale.',
      ] },
      { heading: 'What does not count as a cantilever', list: [
        'Roof eaves and soffits: no floor above them.',
        'An exterior [chimney](/does-a-chimney-count-as-square-footage) bumped out from the wall: masonry, not floor.',
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Inside the walls, yes; bumped out from the wall, no.** ANSI Z765 measures the exterior of the house, so a fireplace and chimney that sit **inside** the exterior wall line are part of the footprint and are counted like a [closet](/do-closets-count-as-square-footage). An exterior chimney that projects **outside** the wall is not living area and is not measured into the square footage. Fireplaces are one of the small shapes covered in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Fireplace bump-outs', paragraphs: [
        'A fireplace built into a small bump-out of the exterior wall is a judgment call: if the bump-out has floor and ceiling at room level (a real alcove), it is measured like a [bay window](/does-a-bay-window-count-as-square-footage); if it is just masonry, it is not, because unlike a [cantilevered floor](/does-a-cantilever-count-as-square-footage) there is no floor to count. Either way it is a few square feet, which is why the standard treats it simply.',
      ] },
    ],
    sources: [src.hirl],
  ...
  },
  {
    ...
    published: D, verdict: YES,
    shortAnswer: '**Yes.** Closets, hallways, bathrooms, pantries, entries, and stairs all count as gross living area under ANSI Z765. The standard measures the entire finished floor to the outside of the exterior walls; it does not add up rooms. Interior walls, closets, and every square foot between them are in the number. The full list, space by space, is in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Why this surprises people', paragraphs: [
        'Room dimensions in a listing (12 by 14 bedroom, 10 by 12 office) add up to far less than the house\'s square footage because they leave out closets, halls, baths, stairs, and every wall. A 2,000 sq ft house often has only 1,400 to 1,500 sq ft of "room" area. The gap is wall thickness, which ANSI counts on purpose. Finished [laundry and utility rooms](/does-a-laundry-room-count-as-square-footage) are in the number too.',
      ] },
  ...
  },
  {
    ...
    published: D, verdict: DEP,
    shortAnswer: '**Yes, if finished and on a finished floor.** A laundry room, mechanical closet, or under-stair storage space that is finished (walls, floor, ceiling) and sits on an above-grade finished level counts as gross living area under ANSI Z765. The same rooms in a basement are below-grade area, and an **unfinished** utility room (bare studs, slab) on any level does not count. Utility space sits with closets and halls in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'The furnace room test', paragraphs: [
        'A furnace room does not have to be pretty, but it has to be finished to the house standard: drywalled, with a finished floor and ceiling. A concrete-floored mechanical room with exposed framing off a finished hallway is excluded from the finished area even though it is inside the exterior walls. Warmth from the furnace does not help, since [heat alone is not the test](/does-heated-space-count-as-square-footage), and a finished utility room counts the same way [closets and hallways](/do-closets-count-as-square-footage) do.',
      ] },
    ],
    sources: [src.hirl],
  ...
  },
  {
    ...
    published: D, verdict: NO,
    shortAnswer: '**No, not automatically.** Heat is one ingredient of finished area, not the test. Under ANSI Z765 a space must be **finished** (walls, floor, ceiling), **above grade**, **7 feet tall**, and **connected** through finished space to count as gross living area. A heated garage, a heated three-season room, and a heated basement all fail at least one of those and stay out of GLA. The tests themselves are laid out in [what counts as square footage](/what-counts-as-square-footage).',
    body: [
      { heading: 'Where the "heated square footage" idea comes from', paragraphs: [
        'Some MLS systems and assessors use "heated square feet" as a shorthand for living area, and in older Southern practice it was common. It is a rough proxy, not a standard, and it overcounts anything heated that is not finished, like an unfinished [furnace room](/does-a-laundry-room-count-as-square-footage). Appraisals working to ANSI do not use it.',
      ] },
