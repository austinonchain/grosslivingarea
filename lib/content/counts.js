...
export const countsQuestions = [
  {
    ...
    body: [
      { heading: 'Why the basement is kept separate', paragraphs: [
        'Appraisers compare houses on above-grade GLA. If basements were mixed in, a 1,800 sq ft ranch with a finished basement would be compared to 3,600 sq ft two-story houses and the numbers would stop meaning anything. The all-sides grade rule in [ANSI Z765](/ansi-z765-2021) draws the line in the same place for every house.',
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'The one real exception', paragraphs: [
        'If a lower level sits entirely above ground on every side (some hillside and split-level homes), it is not below grade at all under [ANSI\'s all-sides rule](/ansi-z765-2021) and counts as GLA. That is a fact about the site, not something a remodel can create.',
      ] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    body: [
      { heading: 'Why "walkout" does not mean "above grade"', paragraphs: [
        'The all-sides rule in [ANSI Z765](/ansi-z765-2021) looks at every side of the level. A walkout has a door and full windows on the downhill side and a foundation wall in the dirt on the uphill side. One buried side is enough, and so is one inch: ANSI sets no minimum depth, so a floor slab even 1 inch below the finished ground on any side makes the whole level below grade.',
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      ], after: ['All three fail [ANSI\'s all-sides rule](/ansi-z765-2021) the same way. The names describe light and access, not grade.'] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    body: [
      { heading: 'Two separate questions', paragraphs: [
        '"Is it a legal bedroom?" is a **building code** question: egress, minimum size, ceiling height, heat. "Does it count as GLA?" is an **ANSI grade** question. A room can pass the first and fail the second, which is exactly what a good basement bedroom does. [ANSI Z765](/ansi-z765-2021) has no bedroom rules of its own; it only measures.',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'Why split-levels cause arguments', paragraphs: [
        'The lower level of a split-level looks and lives like the rest of the house: same finishes, same ceiling height, full windows. Buyers and MLS listings count it. The all-sides rule in [ANSI Z765](/ansi-z765-2021) does not care how it lives; it looks at where the ground is. A lower level that is 3 feet down on the front is below grade, and so is one that is 1 inch down. ANSI has no minimum depth; any part below ground on any side puts the whole level below grade.',
  ...
  },
  {
    ...
    body: [
      { heading: 'The ceiling math, worked', paragraphs: [
        'A finished attic room is 24 by 14 feet (336 sq ft). The ridge runs down the middle. Headroom is 7 feet or more across the center 8 feet of width (192 sq ft, 57%), so the room qualifies. Headroom is 5 feet or more across the center 11 feet (264 sq ft). **264 sq ft counts**; the 72 sq ft under the eaves does not. The ceiling-height math comes straight from [ANSI Z765](/ansi-z765-2021).',
      ] },
      { heading: 'Access', paragraphs: [
        'A pull-down stairway or scuttle hole fails [ANSI\'s finished-connection rule](/ansi-z765-2021) no matter how well the attic is finished. A permanent stair with finished walls fixes it. This is the exact scenario on many real estate license exams.',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'Common ways bonus rooms fail', list: [
        ...
        'Knee-wall ceilings that put less than half the room at 7 feet, which fails the [ANSI ceiling rule](/ansi-z765-2021).',
  ...
  },
  {
    ...
    body: [
      { heading: 'What disqualifies a loft', list: [
        'Ceiling under 7 feet over more than half the floor, which fails the [ANSI ceiling rule](/ansi-z765-2021).',
        'Access by ladder or ship\'s stair with no finished stairway (fails [ANSI\'s finished-connection rule](/ansi-z765-2021)).',
        'Unfinished storage loft in a garage or barn.',
      ] },
      { heading: 'Two-story foyers and great rooms', paragraphs: [
        'The volume over a two-story living room is not floor. It is counted on the first floor only. A second-floor hallway that bridges across it is counted for its own width. Same rule as stairs in the [ANSI Z765 guide](/ansi-z765-2021): count floor, not air.',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['does-a-finished-attic-count-as-square-footage'],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Balconies', paragraphs: [
        'A balcony on a house or condo is never GLA. Some condo listings quote "total area" including balconies; the appraisal will not. Condos are one of the gaps the [ANSI Z765 guide](/ansi-z765-2021) covers under what the standard does not address.',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'Why the breezeway decides more than its own area', paragraphs: [
        '[ANSI\'s finished-connection rule](/ansi-z765-2021) needs finished space all the way from the house to the room. An enclosed breezeway can turn a garage apartment or guest suite into part of the house; an open one leaves it [reported separately](/does-a-garage-apartment-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
  ...
  },
  {
    ...
    body: [
      { heading: 'How appraisers handle it', paragraphs: [
        'The bay is measured as a small bump in the exterior footprint. On a sketch it adds a few square feet, which is why bay windows show up as odd angles on appraisal drawings. That is a direct result of [ANSI measuring from the outside](/ansi-z765-2021) of the walls.',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'Measuring an overhang', paragraphs: [
        'Because you cannot walk around a cantilevered second floor, the appraiser measures it from inside and adds the wall thickness, or measures the overhang from below. Garrison-style colonials and modern boxes with cantilevered upper floors are the usual cases. They count because [ANSI measures the exterior](/ansi-z765-2021), and a cantilever has an exterior.',
      ] },
