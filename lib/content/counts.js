...
export const countsQuestions = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Does Zillow square footage include the garage?', a: 'It should not, but sometimes it does by mistake. Zillow pulls square footage from tax records, and some assessors record total building area with the garage included. The appraised figure never includes it.' },
