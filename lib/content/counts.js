...
const basementNumbers = {
  ...
  paragraphs: [
    ...
    `The number that explains most square footage arguments: ${Math.round(usNow.pct_owners_count_basement_in_sqft)}% of owners with a basement include it when they report their home's size. Under ANSI Z765 none of them should. The state pages below give the same figures for each state.`,
  ],
};
...
export const countsQuestions = [
  {
    ...
    stateHeading: 'Does a basement count as square footage in your state?',
  ...
  },
  {
    ...
    shortAnswer: '**No.** An unfinished basement is not living area of any kind. ANSI Z765 keeps every basement out of gross living area because it is below grade, and an unfinished one does not make the below-grade finished line either. The appraiser measures it and reports it as unfinished below-grade area, which carries a small adjustment for the space and the storage.',
    body: [
  ...
  },
  {
    ...
    published: D2, verdict: BELOW,
    shortAnswer: '**No, and only the finished part counts even as below-grade finished area.** ANSI Z765 keeps the whole basement out of gross living area because it is below grade. Within the basement the appraiser measures the finished rooms separately: space with finished walls, floor, and ceiling goes on the finished line, and everything else is reported as unfinished.',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      basementNumbers,
      basementCalculator('a walkout basement', 'below-grade finished area'),
      basementTrend,
    ],
    faq: [
