...
const D = '2026-08-27';
const FNMA_GUIDE = 'https://selling-guide.fanniemae.com/sel/b4-1.3-05/residential-appraisal-report-improvements-section';
...
const HIRL = 'https://www.homeinnovation.com/z765';
...
export const countsPillar = {
  ...
  title: 'What Counts as Square Footage? Every Space, Ruled',
  ...
  intro: [
    ...
    'Below is the master table. Every row links to a page with the verdict, the ANSI rule behind it, and the Fannie Mae or FHA wrinkle. The rules themselves are explained in [ANSI Z765-2021, every rule in plain English](/ansi-z765-2021).',
  ],
  body: [
    {
      heading: 'Counts or does not count: the master table',
      table: {
  ...
  childrenHeading: 'Every "does it count?" question, one page each',
  faq: [
...
export const countsQuestions = [
  {
    ...
    shortAnswer: '**Not as gross living area.** A finished basement is measured and reported on an appraisal, but as **below-grade finished area** on its own line, because under ANSI Z765 any level with part of it below ground is below grade. It still adds value; it just is not added to the house\'s GLA.',
    body: [
      { heading: 'Why the basement is kept separate', paragraphs: [
        'Appraisers compare houses on above-grade GLA. If basements were mixed in, a 1,800 sq ft ranch with a finished basement would be compared to 3,600 sq ft two-story houses and the numbers would stop meaning anything. The [all-sides grade rule](/above-grade-vs-below-grade) draws the line in the same place for every house.',
      ] },
      { heading: 'What it is worth instead', paragraphs: [
        'The appraiser values the finished basement as a separate adjustment, typically a fraction of the per-square-foot value of above-grade space, with more for a walkout or a full bath. Listings, tax records, and Zillow often add the basement into a "total" figure, which is where the confusion starts. See [how to make a basement count](/how-to-make-a-basement-count-as-square-footage).',
      ] },
    ...
    sources: basementSrc,
    related: ['how-to-make-a-basement-count-as-square-footage', 'does-a-walkout-basement-count-as-square-footage', 'above-grade-vs-below-grade'],
  },
  {
    ...
    body: [
      ...
      { heading: 'The one real exception', paragraphs: [
        'If a lower level sits entirely above ground on every side (some hillside and split-level homes), it is not below grade at all under the [all-sides rule](/above-grade-vs-below-grade) and counts as GLA. That is a fact about the site, not something a remodel can create.',
      ] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    body: [
      { heading: 'Why "walkout" does not mean "above grade"', paragraphs: [
        'The [all-sides rule](/above-grade-vs-below-grade) looks at every side of the level. A walkout has a door and full windows on the downhill side and a foundation wall in the dirt on the uphill side. One buried side is enough.',
      ] },
      { heading: 'Is a walkout basement considered above grade anywhere?', paragraphs: [
        'Some local MLS systems and tax assessors treat walkouts as living area, and some markets price them close to above-grade space. An appraiser can adjust for that in value, but on a Fannie Mae appraisal the square footage still goes on the below-grade line. See [does a finished basement count?](/does-a-finished-basement-count-as-square-footage).',
      ] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    body: [
      { heading: 'Daylight vs. lookout vs. walkout', list: [
        ...
        '**Walkout:** a door at floor level to the outside on the low side. See [walkout basements](/does-a-walkout-basement-count-as-square-footage).',
      ], after: ['All three fail the [all-sides rule](/above-grade-vs-below-grade) the same way. The names describe light and access, not grade.'] },
    ],
    sources: basementSrc,
  ...
  },
  {
    ...
    body: [
      { heading: 'Two separate questions', paragraphs: [
        '"Is it a legal bedroom?" is a **building code** question: egress, minimum size, ceiling height, heat. "Does it count as GLA?" is an **ANSI grade** question. A room can pass the first and fail the second, which is exactly what a good basement bedroom does. ANSI has [no bedroom rules of its own](/ansi-bedroom-requirements).',
      ] },
    ...
    related: ['do-egress-windows-count-as-square-footage', 'does-a-finished-basement-count-as-square-footage', 'ansi-bedroom-requirements'],
  },
  {
    ...
    body: [
      { heading: 'Why split-levels cause arguments', paragraphs: [
        'The lower level of a split-level looks and lives like the rest of the house: same finishes, same ceiling height, full windows. Buyers and MLS listings count it. The [all-sides rule](/above-grade-vs-below-grade) does not care how it lives; it looks at where the ground is. A lower level that is 3 feet down on the front is below grade.',
      ...
      { heading: 'The bi-level (raised ranch) case', paragraphs: [
        'A bi-level has its entry between floors and its lower level partly buried; it is treated the same way. See [raised ranch lower levels](/does-a-raised-ranch-lower-level-count-as-square-footage).',
      ] },
    ],
    sources: basementSrc,
    related: ['does-a-raised-ranch-lower-level-count-as-square-footage', 'above-grade-vs-below-grade'],
  },
  {
  ...
  },
  {
    ...
    body: [
      { heading: 'The all-sides rule on a slope', paragraphs: [
        'It only takes one side. A lower level with a 20-foot wall of glass facing the view and a retaining wall of dirt on the back is below grade. The [rule](/above-grade-vs-below-grade) is deliberately blunt so that every measurer gets the same answer.',
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      ], after: ['None of that touches the square footage line. See [does a basement bedroom count as square footage?](/does-a-basement-bedroom-count-as-square-footage) and [how to make a basement count](/how-to-make-a-basement-count-as-square-footage).'] },
    ],
    sources: [src.fnmaAnsi, src.hud],
    related: ['does-a-basement-bedroom-count-as-square-footage', 'ansi-bedroom-requirements'],
  },
  {
    ...
    body: [
      { heading: 'The ceiling math, worked', paragraphs: [
        'A finished attic room is 24 by 14 feet (336 sq ft). The ridge runs down the middle. Headroom is 7 feet or more across the center 8 feet of width (192 sq ft, 57%), so the room qualifies. Headroom is 5 feet or more across the center 11 feet (264 sq ft). **264 sq ft counts**; the 72 sq ft under the eaves does not. Full rule: [ANSI ceiling height requirements](/ansi-ceiling-height-requirements).',
      ] },
      { heading: 'Access', paragraphs: [
        'A pull-down stairway or scuttle hole fails the [finished-connection rule](/finished-connection-rule) no matter how well the attic is finished. A permanent stair with finished walls fixes it. This is the exact scenario on many real estate license exams.',
      ] },
    ...
    related: ['does-a-cape-cod-second-floor-count-as-square-footage', 'ansi-ceiling-height-requirements', 'finished-connection-rule'],
  },
  {
    ...
    body: [
      { heading: 'Common ways bonus rooms fail', list: [
        ...
        'Knee-wall ceilings that put less than half the room at 7 feet. See [ceiling height requirements](/ansi-ceiling-height-requirements).',
      ...
      { heading: 'The garage below still never counts', paragraphs: [
        'Counting the room above does not pull the garage in. See [does a garage count as square footage?](/does-a-garage-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['finished-connection-rule', 'does-a-garage-count-as-square-footage', 'does-a-finished-attic-count-as-square-footage'],
  },
  {
    ...
    sources: [src.hirl, src.fnmaAnsi],
    related: ['does-a-finished-attic-count-as-square-footage', 'ansi-ceiling-height-requirements'],
  },
  {
    ...
    body: [
      { heading: 'What disqualifies a loft', list: [
        'Ceiling under 7 feet over more than half the floor. See [ceiling height requirements](/ansi-ceiling-height-requirements).',
        'Access by ladder or ship\'s stair with no finished stairway (fails the [finished-connection rule](/finished-connection-rule)).',
        'Unfinished storage loft in a garage or barn.',
      ] },
      { heading: 'Two-story foyers and great rooms', paragraphs: [
        'The volume over a two-story living room is not floor. It is counted on the first floor only. A second-floor hallway that bridges across it is counted for its own width. Same rule as [stairs](/do-stairs-count-as-square-footage): count floor, not air.',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['do-stairs-count-as-square-footage', 'does-a-finished-attic-count-as-square-footage'],
  },
  {
    ...
    body: [
      ...
      { heading: 'Heated garages and workshops', paragraphs: [
        'Heat does not make space living area. See [does heated space count?](/does-heated-space-count-as-square-footage). A garage used as a workshop is still a garage.',
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Manufactured sunroom kits', paragraphs: [
        'Most aluminum-and-glass sunroom kits are three-season rooms even when the owner adds a heater. Appraisers judge by construction and finish level, not by the thermostat. See [does heated space count?](/does-heated-space-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Balconies', paragraphs: [
        'A balcony on a house or condo is never GLA. Some condo listings quote "total area" including balconies; the appraisal will not. See [what ANSI does not apply to](/what-ansi-does-not-apply-to) for condos.',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'Why the breezeway decides more than its own area', paragraphs: [
        'The [finished-connection rule](/finished-connection-rule) needs finished space all the way from the house to the room. An enclosed breezeway can turn a garage apartment or guest suite into part of the house; an open one leaves it [reported separately](/does-a-garage-apartment-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['does-a-screened-porch-count-as-square-footage', 'finished-connection-rule'],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'Why the GLA line matters less than people think', paragraphs: [
        'Buyers looking for an ADU pay for the unit, not for 600 extra square feet of GLA. Keeping it separate lets the appraiser compare the house to houses and the unit to units. See [guest houses and garage apartments](/does-a-garage-apartment-count-as-square-footage).',
      ] },
    ],
    sources: [src.fnma, src.fnmaAnsi],
  ...
  },
  {
    ...
    body: [
      { heading: 'How it is valued', paragraphs: [
        'As an accessory building or unit, based on what buyers in the market pay for one, not on a per-square-foot GLA rate. A 600 sq ft casita with a kitchen and bath can add far more than 600 sq ft of GLA would; it just shows up on a different line. See [does an ADU count?](/does-an-adu-count-as-square-footage).',
      ] },
    ],
  ...
  },
  {
    ...
    body: [
      { heading: 'Interior connection is the test', paragraphs: [
        'Many in-law suites have their own exterior door, which is fine as long as there is also a door into the house through finished space. If the only access is from outside, the [finished-connection rule](/finished-connection-rule) treats it like an [ADU](/does-an-adu-count-as-square-footage) and it is reported separately.',
      ] },
      { heading: 'Second kitchens and zoning', paragraphs: [
        'A second kitchen can raise zoning questions (is this a two-unit property?) and permit questions. Those affect value and lending, not the measurement. See [unpermitted additions](/does-an-unpermitted-addition-count-as-square-footage).',
      ] },
    ],
    sources: [src.fnma, src.fnmaAnsi],
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'How the appraisal shows it', paragraphs: [
        'Outbuildings appear in the site or improvements description with their size and condition, and get a lump-sum adjustment against comparable sales that lack them. A 200 sq ft shed is usually a few thousand dollars; a finished 400 sq ft studio with power and plumbing can be much more, but it is still not GLA.',
        'The one way an outbuilding joins the house is an enclosed, finished connector. See [does a breezeway count?](/does-a-breezeway-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnma],
  ...
  },
  {
    ...
    body: [
      { heading: 'How appraisers handle it', paragraphs: [
        'The bay is measured as a small bump in the exterior footprint. On a sketch it adds a few square feet, which is why bay windows show up as odd angles on appraisal drawings. See [why ANSI measures from the outside](/exterior-measurement).',
      ] },
    ...
    sources: [src.hirl],
    related: ['does-a-cantilever-count-as-square-footage', 'exterior-measurement'],
  },
  {
    ...
    body: [
      { heading: 'Measuring an overhang', paragraphs: [
        'Because you cannot walk around a cantilevered second floor, the appraiser measures it from inside and adds the wall thickness, or measures the overhang from below. Garrison-style colonials and modern boxes with cantilevered upper floors are the usual cases. See [exterior measurement](/exterior-measurement).',
      ] },
  ...
  },
  {
    ...
    body: [
      { heading: 'Why this surprises people', paragraphs: [
        'Room dimensions in a listing (12 by 14 bedroom, 10 by 12 office) add up to far less than the house\'s square footage because they leave out closets, halls, baths, stairs, and every wall. A 2,000 sq ft house often has only 1,400 to 1,500 sq ft of "room" area. See [why wall thickness is included](/exterior-measurement).',
      ] },
      { heading: 'What does not count on a finished floor', paragraphs: [
        'Open-to-below areas, unfinished storage, and any attached garage space. See [does a loft count?](/does-a-loft-count-as-square-footage) and [does a garage count?](/does-a-garage-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
    related: ['does-a-laundry-room-count-as-square-footage', 'exterior-measurement'],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      { heading: 'The reverse question', paragraphs: [
        'Can unheated space count? No. Suitable for year-round use means conditioned. A finished but unheated room is not finished area either. See [does a sunroom count?](/does-a-sunroom-count-as-square-footage) and [does a garage count?](/does-a-garage-count-as-square-footage).',
      ] },
    ],
    sources: [src.hirl, src.fnmaAnsi],
