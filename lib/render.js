...
// A body section: { heading?, paragraphs?: [], list?: [], ordered?: bool, table?: { head: [], rows: [[]] }, calculator?, chart?, after? }
export function Section({ section, level = 2 }) {
  ...
  return (
    <section>
      ...
      {section.calculator && <Calculator {...section.calculator} />}
      {section.chart && <LineChart {...section.chart} />}
